...
const (
	...
	// DSA
	DSA_STATE_IN_PROGRESS     = "in progress"
	DSA_STATE_FAILED          = "failed"
	DSA_STATE_SUCCEEDED       = "succeeded"
	DSA_OPERATION_TYPE_CREATE = "create"
	DSA_OPERATION_TYPE_UPDATE = "update"
	DSA_OPERATION_TYPE_DELETE = "delete"
)
