...
func (c *Client) GetVersions(ctx context.Context, projectID string, params *GetVersionsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetVersionsRequest(ctx, c.Server, projectID, params)
	if err != nil {
		return nil, err
	}
...
func NewGetVersionsRequest(ctx context.Context, server string, projectID string, params *GetVersionsParams) (*http.Request, error) {
	var err error
