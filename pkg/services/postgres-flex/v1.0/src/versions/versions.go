...
type ClientInterface interface {
	// GetVersions request
	GetVersions(ctx context.Context, projectID string, params *GetVersionsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetVersions(ctx context.Context, projectID string, params *GetVersionsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetVersionsRequest(c.Server, projectID, params)
	if err != nil {
		return nil, err
	}
...
func NewGetVersionsRequest(server string, projectID string, params *GetVersionsParams) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	// GetVersions request
	GetVersionsWithResponse(ctx context.Context, projectID string, params *GetVersionsParams, reqEditors ...RequestEditorFn) (*GetVersionsResponse, error)
}
...
func (c *ClientWithResponses) GetVersionsWithResponse(ctx context.Context, projectID string, params *GetVersionsParams, reqEditors ...RequestEditorFn) (*GetVersionsResponse, error) {
	rsp, err := c.GetVersions(ctx, projectID, params, reqEditors...)
	if err != nil {
		return nil, err
	}
