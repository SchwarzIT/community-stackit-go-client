...
func (r CreateResponse) WaitHandler(ctx context.Context, c *ClientWithResponses, projectID, instanceID string) *wait.Handler {
	return createOrUpdateWait(ctx, c, projectID, instanceID, CREATE)
}
...
func (r UpdateResponse) WaitHandler(ctx context.Context, c *ClientWithResponses, projectID, instanceID string) *wait.Handler {
	...
	return createOrUpdateWait(ctx, c, projectID, instanceID, UPDATE)
}

func createOrUpdateWait(ctx context.Context, c *ClientWithResponses, projectID, instanceID string, opType LastOperationType) *wait.Handler {
