...
type BackupScheduleModelJson struct {
	...
	ScheduleID openapiTypes.UUID `json:"scheduleId"`
}
...
func (c *Client[K]) RestoresCreateRaw(ctx context.Context, projectID string, instanceID string, backupDate string, params *RestoresCreateParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) RetentionsListRaw(ctx context.Context, projectID string, instanceID string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) SchedulesListRaw(ctx context.Context, projectID string, instanceID string, params *SchedulesListParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) SchedulesCreateRawWithBody(ctx context.Context, projectID string, instanceID string, params *SchedulesCreateParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) SchedulesCreateRaw(ctx context.Context, projectID string, instanceID string, params *SchedulesCreateParams, body SchedulesCreateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) ListRaw(ctx context.Context, projectID string, instanceID string, params *ListParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) CreateRaw(ctx context.Context, projectID string, instanceID string, params *CreateParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *ClientWithResponses[K]) RestoresCreate(ctx context.Context, projectID string, instanceID string, backupDate string, params *RestoresCreateParams, reqEditors ...RequestEditorFn) (*RestoresCreateResponse, error) {
...
func (c *ClientWithResponses[K]) RetentionsList(ctx context.Context, projectID string, instanceID string, reqEditors ...RequestEditorFn) (*RetentionsListResponse, error) {
...
func (c *ClientWithResponses[K]) SchedulesList(ctx context.Context, projectID string, instanceID string, params *SchedulesListParams, reqEditors ...RequestEditorFn) (*SchedulesListResponse, error) {
...
func (c *ClientWithResponses[K]) SchedulesCreateWithBody(ctx context.Context, projectID string, instanceID string, params *SchedulesCreateParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SchedulesCreateResponse, error) {
...
func (c *ClientWithResponses[K]) SchedulesCreate(ctx context.Context, projectID string, instanceID string, params *SchedulesCreateParams, body SchedulesCreateJSONRequestBody, reqEditors ...RequestEditorFn) (*SchedulesCreateResponse, error) {
...
func (c *ClientWithResponses[K]) List(ctx context.Context, projectID string, instanceID string, params *ListParams, reqEditors ...RequestEditorFn) (*ListResponse, error) {
...
func (c *ClientWithResponses[K]) Create(ctx context.Context, projectID string, instanceID string, params *CreateParams, reqEditors ...RequestEditorFn) (*CreateResponse, error) {
...
func (c *ClientWithResponses[K]) ParseRestoresCreateResponse(rsp *http.Response) (*RestoresCreateResponse, error) {
...
func (c *ClientWithResponses[K]) ParseRetentionsListResponse(rsp *http.Response) (*RetentionsListResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
func (c *ClientWithResponses[K]) ParseSchedulesListResponse(rsp *http.Response) (*SchedulesListResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
func (c *ClientWithResponses[K]) ParseSchedulesCreateResponse(rsp *http.Response) (*SchedulesCreateResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
