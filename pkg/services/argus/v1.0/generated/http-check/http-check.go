...
type ClientInterface interface {
	...
	// Delete request
	Delete(ctx context.Context, projectID string, instanceID string, targetURL string, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) Delete(ctx context.Context, projectID string, instanceID string, targetURL string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	...
	// Delete request
	DeleteWithResponse(ctx context.Context, projectID string, instanceID string, targetURL string, reqEditors ...RequestEditorFn) (*DeleteResponse, error)
}
...
func (c *ClientWithResponses) DeleteWithResponse(ctx context.Context, projectID string, instanceID string, targetURL string, reqEditors ...RequestEditorFn) (*DeleteResponse, error) {
	rsp, err := c.Delete(ctx, projectID, instanceID, targetURL, reqEditors...)
	if err != nil {
		return nil, err
	}
