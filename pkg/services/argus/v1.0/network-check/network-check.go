...
func (c *ClientWithResponses[K]) Delete(ctx context.Context, projectID string, instanceID string, address string, reqEditors ...RequestEditorFn) (*DeleteResponse, error) {
