...
// PingCheckChildResponse defines model for PingCheckChildResponse.
type PingCheckChildResponse struct {
	URL string `json:"url"`
}

// PingCheckResponse defines model for PingCheckResponse.
...
type rawClientInterface interface {
	...
	// Delete request
	DeleteRaw(ctx context.Context, projectID string, instanceID string, domain string, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) DeleteRaw(ctx context.Context, projectID string, instanceID string, domain string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteRequest(ctx, c.Server, projectID, instanceID, domain)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewListRequest(ctx context.Context, server string, projectID string, instanceID string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/projects/%s/instances/%s/ping-checks", pathParam0, pathParam1)
	if operationPath[0] == '/' {
...
func NewDeleteRequest(ctx context.Context, server string, projectID string, instanceID string, domain string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/projects/%s/instances/%s/ping-checks/%s", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// Delete request
	Delete(ctx context.Context, projectID string, instanceID string, domain string, reqEditors ...RequestEditorFn) (*DeleteResponse, error)
}

type ListResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *PingCheckResponse
...
func (c *ClientWithResponses) Delete(ctx context.Context, projectID string, instanceID string, domain string, reqEditors ...RequestEditorFn) (*DeleteResponse, error) {
	rsp, err := c.DeleteRaw(ctx, projectID, instanceID, domain, reqEditors...)
	if err != nil {
		return nil, err
	}
