...
type rawClientInterface interface {
	...
	// Delete request
	DeleteRaw(ctx context.Context, projectID string, instanceID string, targetURL string, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) DeleteRaw(ctx context.Context, projectID string, instanceID string, targetURL string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteRequest(ctx, c.Server, projectID, instanceID, targetURL)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewListRequest(ctx context.Context, server string, projectID string, instanceID string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1/projects/%s/instances/%s/http-checks", pathParam0, pathParam1)
	if operationPath[0] == '/' {
...
func NewDeleteRequest(ctx context.Context, server string, projectID string, instanceID string, targetURL string) (*http.Request, error) {
	var err error
	...
	pathParam2, err = runtime.StyleParamWithLocation("simple", false, "targetURL", runtime.ParamLocationPath, targetURL)
	if err != nil {
		return nil, err
	}
	...
	operationPath := fmt.Sprintf("/v1/projects/%s/instances/%s/http-checks/%s", pathParam0, pathParam1, pathParam2)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// Delete request
	Delete(ctx context.Context, projectID string, instanceID string, targetURL string, reqEditors ...RequestEditorFn) (*DeleteResponse, error)
}
...
func (c *ClientWithResponses) Delete(ctx context.Context, projectID string, instanceID string, targetURL string, reqEditors ...RequestEditorFn) (*DeleteResponse, error) {
	rsp, err := c.DeleteRaw(ctx, projectID, instanceID, targetURL, reqEditors...)
	if err != nil {
		return nil, err
	}
