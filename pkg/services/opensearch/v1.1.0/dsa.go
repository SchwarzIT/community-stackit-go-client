// Package opensearch provides primitives to interact with the openapi HTTP API.
//
...
import (
	...
	"github.com/SchwarzIT/community-stackit-go-client/pkg/services/opensearch/v1.1.0/offerings"
)
