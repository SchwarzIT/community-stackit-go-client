...
func (c *Client) DeleteRaw(ctx context.Context, projectID string, keyID string, params *DeleteParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetRaw(ctx context.Context, projectID string, params *GetParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *ClientWithResponses) Delete(ctx context.Context, projectID string, keyID string, params *DeleteParams, reqEditors ...RequestEditorFn) (*DeleteResponse, error) {
...
func (c *ClientWithResponses) Get(ctx context.Context, projectID string, params *GetParams, reqEditors ...RequestEditorFn) (*GetResponse, error) {
