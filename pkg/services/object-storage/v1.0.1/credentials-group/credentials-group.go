...
func (c *Client[K]) DeleteRaw(ctx context.Context, projectID string, groupID string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *ClientWithResponses[K]) Delete(ctx context.Context, projectID string, groupID string, reqEditors ...RequestEditorFn) (*DeleteResponse, error) {
