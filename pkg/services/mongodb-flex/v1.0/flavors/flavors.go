...
func (c *Client[K]) GetStorageOptionsRaw(ctx context.Context, projectID string, flavor string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *ClientWithResponses[K]) GetStorageOptions(ctx context.Context, projectID string, flavor string, reqEditors ...RequestEditorFn) (*GetStorageOptionsResponse, error) {
