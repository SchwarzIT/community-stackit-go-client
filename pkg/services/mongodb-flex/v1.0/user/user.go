...
func (c *Client[K]) PatchRawWithBody(ctx context.Context, projectID string, instanceID string, userID string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) PatchRaw(ctx context.Context, projectID string, instanceID string, userID string, body PatchJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) UpdateRawWithBody(ctx context.Context, projectID string, instanceID string, userID string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) UpdateRaw(ctx context.Context, projectID string, instanceID string, userID string, body UpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client[K]) ResetPasswordRaw(ctx context.Context, projectID string, instanceID string, userID string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *ClientWithResponses[K]) PatchWithBody(ctx context.Context, projectID string, instanceID string, userID string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PatchResponse, error) {
...
func (c *ClientWithResponses[K]) Patch(ctx context.Context, projectID string, instanceID string, userID string, body PatchJSONRequestBody, reqEditors ...RequestEditorFn) (*PatchResponse, error) {
...
func (c *ClientWithResponses[K]) UpdateWithBody(ctx context.Context, projectID string, instanceID string, userID string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateResponse, error) {
...
func (c *ClientWithResponses[K]) Update(ctx context.Context, projectID string, instanceID string, userID string, body UpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateResponse, error) {
...
func (c *ClientWithResponses[K]) ResetPassword(ctx context.Context, projectID string, instanceID string, userID string, reqEditors ...RequestEditorFn) (*ResetPasswordResponse, error) {
...
func (c *ClientWithResponses[K]) ParseResetPasswordResponse(rsp *http.Response) (*ResetPasswordResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
