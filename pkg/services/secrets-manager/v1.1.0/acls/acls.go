...
type rawClientInterface interface {
	...
	// Delete request
	DeleteRaw(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// Get request
	GetRaw(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, reqEditors ...RequestEditorFn) (*http.Response, error)

	// Update request with any body
	UpdateRawWithBody(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UpdateRaw(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, body UpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) DeleteRaw(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewDeleteRequest(ctx, c.Server, projectId, instanceId, aclId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetRaw(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetRequest(ctx, c.Server, projectId, instanceId, aclId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateRawWithBody(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateRequestWithBody(ctx, c.Server, projectId, instanceId, aclId, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) UpdateRaw(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, body UpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewUpdateRequest(ctx, c.Server, projectId, instanceId, aclId, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewDeleteRequest(ctx context.Context, server string, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID) (*http.Request, error) {
	var err error
...
func NewGetRequest(ctx context.Context, server string, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID) (*http.Request, error) {
	var err error
...
func NewUpdateRequest(ctx context.Context, server string, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, body UpdateJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewUpdateRequestWithBody(ctx, server, projectId, instanceId, aclId, "application/json", bodyReader)
}

// NewUpdateRequestWithBody generates requests for Update with any type of body
func NewUpdateRequestWithBody(ctx context.Context, server string, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
func (c *ClientWithResponses) Delete(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, reqEditors ...RequestEditorFn) (*DeleteResponse, error) {
	rsp, err := c.DeleteRaw(ctx, projectId, instanceId, aclId, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) Get(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, reqEditors ...RequestEditorFn) (*GetResponse, error) {
	rsp, err := c.GetRaw(ctx, projectId, instanceId, aclId, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) UpdateWithBody(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*UpdateResponse, error) {
	rsp, err := c.UpdateRawWithBody(ctx, projectId, instanceId, aclId, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) Update(ctx context.Context, projectId openapiTypes.UUID, instanceId openapiTypes.UUID, aclId openapiTypes.UUID, body UpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*UpdateResponse, error) {
	rsp, err := c.UpdateRaw(ctx, projectId, instanceId, aclId, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return c.ParseUpdateResponse(rsp)
