...
func TestPostgresInstancesService_List(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotRes, err := postgres.Instances.List(tt.args.ctx, tt.args.projectID)
			if (err != nil) != tt.wantErr {
				t.Errorf("PostgresInstancesService.List() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(gotRes, tt.wantRes) && !tt.wantErr {
				t.Errorf("PostgresInstancesService.List() = %v, want %v", gotRes, tt.wantRes)
			}
		})
	}
}
...
func TestPostgresInstancesService_Get(t *testing.T) {
	c, mux, teardown, _ := client.MockServer()
	defer teardown()
	postgres := postgres.New(c)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotRes, err := postgres.Instances.Get(tt.args.ctx, tt.args.projectID, tt.args.instanceID)
			if (err != nil) != tt.wantErr {
				t.Errorf("PostgresInstancesService.Get() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(gotRes, tt.wantRes) && !tt.wantErr {
				t.Errorf("PostgresInstancesService.Get() = %v, want %v", gotRes, tt.wantRes)
			}
		})
	}
}

func TestPostgresInstancesService_Create(t *testing.T) {
	c, mux, teardown, _ := client.MockServer()
	defer teardown()
	postgres := postgres.New(c)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotRes, gotW, err := postgres.Instances.Create(tt.args.ctx, tt.args.projectID, tt.args.instanceName, tt.args.flavorID, tt.args.storage, tt.args.version, tt.args.replicas, tt.args.backupSchedule, tt.args.labels, tt.args.options, tt.args.acl)
			if (err != nil) != tt.wantErr {
				t.Errorf("PostgresInstancesService.Create() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(gotRes, tt.wantRes) {
				t.Errorf("PostgresInstancesService.Create() gotRes = %v, want %v", gotRes, tt.wantRes)
			}
			if tt.useWait {
				process = gotW
			}
...
func TestPostgresInstancesService_Update(t *testing.T) {
	c, mux, teardown, _ := client.MockServer()
	defer teardown()
	postgres := postgres.New(c)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotRes, _, err := postgres.Instances.Update(tt.args.ctx, tt.args.projectID, tt.args.instanceID, tt.args.flavorID, tt.args.backupSchedule, tt.args.labels, tt.args.options, tt.args.acl)
			if (err != nil) != tt.wantErr {
				t.Errorf("PostgresInstancesService.Update() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(gotRes, tt.wantRes) {
				t.Errorf("PostgresInstancesService.Update() gotRes = %v, want %v", gotRes, tt.wantRes)
			}
		})
	}
}

func TestPostgresInstancesService_Delete(t *testing.T) {
	c, mux, teardown, _ := client.MockServer()
	defer teardown()
	postgres := postgres.New(c)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotW, err := postgres.Instances.Delete(tt.args.ctx, tt.args.projectID, tt.args.instanceID)
			if (err != nil) != tt.wantErr {
				t.Errorf("PostgresInstancesService.Delete() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if tt.useWait {
				process = gotW
